...
We can then set the next value of the result node to be the returned value of calling our recursive algorithm with the next value nodes of both linked list pointers, the calculated carry value, and a new empty 
...
We can compute a binary search using a recursive algorithm but this time, also pass in the current row into the binary method.
...
We can then return the appropriate Boolean 